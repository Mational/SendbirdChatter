...
fun RegisterScreen() {
    ...
    val fillState = uiState as? RegisterState.FillFormState
    ...
    Column(
        ...
        if (uiState is RegisterState.FillFormState) {
            Text(
            ...
            TextField(
                ...
                value = (uiState as RegisterState.FillFormState).email,
            ...
            TextField(
                modifier = Modifier.fillMaxWidth().background(Color.Black),
                value = (uiState as RegisterState.FillFormState).password,
            ...
            TextField(
                modifier = Modifier.fillMaxWidth().background(Color.Black),
                value = (uiState as RegisterState.FillFormState).confirmPassword,
                onValueChange = { viewModel.onConfirmPasswordValueChange(it) },
                visualTransformation = PasswordVisualTransformation(),
            ...
            Row(
                ...
                TextButton(
                    onClick = {
                        viewModel.navigateTo(Screens.LoginRoute.route)
                    }
                ) { Text(text = "Back to login screen") }
            }
        } else if (uiState is RegisterState.LoadingState) {
